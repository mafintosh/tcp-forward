...
class ServerState {
  constructor (tunnel, id) {
    ...
    this.open = thunky((cb) => {
      ...
      this.server = net.createServer({ allowHalfOpen: true }, this.onconnection.bind(this))
...
module.exports = class RemoteTunnel extends events.EventEmitter {
  constructor () {
    super()
    this.control = net.createServer({ allowHalfOpen: true }, this.onconnection.bind(this))
